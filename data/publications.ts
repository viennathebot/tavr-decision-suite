...
export const PUBLICATIONS: Publication[] = [
  ...
  // ── 25. PARTNER 2A ──────────────────────────────────────────
  {
    ...
    keyFindings: [
      ...
      'Transfemoral TAVR superior to SAVR for primary endpoint',
      'Better quality of life and faster recovery with TAVR',
      'Expanded TAVR indication to intermediate surgical risk',
    ],
    clinicalTakeaway: 'PARTNER 2A extended TAVR indication to intermediate-risk patients; transfemoral TAVR showed superior outcomes vs SAVR.',
    tags: ['partner', 'landmark-trial', 'rct', 'intermediate-risk', 'tavr-vs-savr'],
    evidenceLevel: 'A',
    primaryOutcome: '2-year death or disabling stroke',
  },
  ...
  // ── 26. PARTNER 3 ───────────────────────────────────────────
  {
    ...
    keyFindings: [
      ...
      'Lower rates of stroke, new AF, and shorter hospital stay with TAVR',
      'Similar paravalvular leak rates with newer-generation SAPIEN 3 valve',
      'Extended TAVR to all surgical risk categories',
    ],
    clinicalTakeaway: 'PARTNER 3 established TAVR superiority over SAVR in low-risk patients, fundamentally expanding TAVR eligibility.',
    tags: ['partner', 'landmark-trial', 'rct', 'low-risk', 'tavr-vs-savr', 'sapien-3'],
    evidenceLevel: 'A',
    primaryOutcome: '1-year composite of death, stroke, or rehospitalization',
  },
  ...
  // ── 27. Evolut Low Risk ─────────────────────────────────────
  {
    ...
    keyFindings: [
      ...
      'Lower mean gradient with self-expanding valve vs surgical bioprosthesis',
      'Higher permanent pacemaker rate with self-expanding TAVR (~17%)',
      'Validated low-risk TAVR with self-expanding platform',
    ],
    clinicalTakeaway: 'Evolut Low Risk confirmed TAVR non-inferiority to SAVR in low-risk patients using the self-expanding platform.',
